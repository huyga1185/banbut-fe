          ...
          <div className="row">
            <div className="col-12 col-lg-6">
              <img
                ...
                className="mb-2"
              />
              <h1>Tìm tài khoản Lorem Ipsum của bạn</h1>
            ...
            <div className="col-12 col-lg-6">
              ...
              <form>
                ...
                <div className="form-group form-floating d-flex mb-4">
                  <input type="number" id="otp" placeholder="" className="form-control no-spinner w-75" required />
                  <label htmlFor="otp">Nhập mã OTP của bạn</label>
                  <button type="button" className="btn btn-primary mb-1 ms-2 fw-bold w-25">
                    Nhận OTP
                  </button>
                </div>
                <div className="d-flex justify-content-end">
                  <button type="button" className="btn btn-primary log_in_btn ps-lg-4 pe-lg-4">
                    Tiếp tục
                  </button>
                </div>
              </form>
