                        ...
                        <div className="col-12 col-lg-6">
                            <form>
                                ...
                                <div className="d-flex justify-content-end">
                                    <button type='button' className='btn sign_up_btn me-2 ps-4 pe-4 pt-2 pt-2'>Tạo tài khoản</button>
                                    <button type='button' className='btn btn-primary log_in_btn ps-4 pe-4 pt-2 pb-2'>Đăng nhập</button>
                                </div>
                            </form>
                        </div>
                    </div>
